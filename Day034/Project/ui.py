...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):  # The data type of quiz_brain is QuizBrain
        ...
        self.question_text = self.canvas.create_text(150, 125, text="Some question here!",
